...
- verify-security-ruleset.sh - pre-existing script migrated into this directory; it verifies an applied ruleset's target, required checks, enforcement, and bypass actors, and is invoked by 04-apply-ruleset.sh as labs/security/verify-security-ruleset.sh.
