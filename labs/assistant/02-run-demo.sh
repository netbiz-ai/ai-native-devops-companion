#!/usr/bin/env bash
# assistant lab, Step 4 - Test the assistant before a live model - run the fake-client command-line demonstration
#
...
# labs/assistant/config/01-knowledge-doc-frontmatter.md). Before that, and for any
